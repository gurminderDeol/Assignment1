...
class GameScene: SKScene {
  ...
  func addMonster() {
    ...
    monster.position = CGPoint(x : actualX+300 , y: size.height )
  ...
  override func touchesEnded(_ touches: Set<UITouch>, with event: UIEvent?) {
    ...
    run(SKAction.playSoundFileNamed("shots.mp3", waitForCompletion: false))
